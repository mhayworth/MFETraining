...
import { addTransaction } from "../../data/DataFetch";

const AddTransactionPage = (): React.ReactElement => {
    ...
    return (
        <>
        {transactionSuccess && <div style={{border:"1px solid green", color:"green"}}>Successfully submitted new transaction!</div>}
